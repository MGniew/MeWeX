...
Precise defining collocation is not a simple task. This problem was nicely illustrated by Choueka in \cite{evert} 
...
Automatic extraction of collocations is a very hard task \cite[c.1,2]{ramisch}. First of all precise specification of collocation is required.
...
\subsection{Compare new results with previous ones}
