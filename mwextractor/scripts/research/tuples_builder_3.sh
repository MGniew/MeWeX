...
relations[0]="${relations_dir}/3r.ccl"
relations[1]="${relations_dir}/3w.ccl"

relations[2]="${relations_dir}/3r1h.ccl"
relations[3]="${relations_dir}/3rw.ccl"

#relations[4]="${relations_dir}/3w1h.ccl"
#relations[5]="${relations_dir}/3rw1h.ccl"
