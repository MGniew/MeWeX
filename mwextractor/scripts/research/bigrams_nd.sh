...
##########################################################################################################
# constants
tool='/media/ptakm/data1/michalw/magisterka/mgr/cmakebin/bin/Miner'
input_dir_base='/media/ptakm/data1/michalw/magisterka/wyniki/storage'
relation_dir='/media/ptakm/data1/michalw/magisterka/mgr/data/patterns/fixed_merged'

corpus="${input_dir_base}/kipi"
output_dir_base='/media/ptakm/data1/michalw/magisterka/wyniki/jakosci/kipi_nowe'
...
write_kbests='1'
write_kbests_length='20000'

quality_functions='-q aprc()'
relevant_set="/media/ptakm/data1/michalw/magisterka/mgr/data/units/MWE_2015_01_20.postlem.csv"
morfeusz='/media/ptakm/data1/michalw/magisterka/wyniki/storage/morfeusz.csv'
frequency='5'
...
command="${tool} -r ${relevant_set} ${quality_functions} -R ${rounds} -F ${folds} -T ${threads} -e ${fix_relevant_order} -w ${write_kbests} -W ${write_kbests_length} ${bigram_functions}"
